System.register([], function (_export, _context) {
  ...
  function onGameStarted(cc, settings) {
    ...
    var Cocos3dGameContainer = document.getElementById('Cocos3dGameContainer');
    var PreloaderContent = document.getElementById('PreloaderContent');
