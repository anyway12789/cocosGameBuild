...
System.register("chunks:///_virtual/request.mjs_cjs=&original=.js", ['./cjs-loader.mjs', './request.js'], function (exports, module) {
  'use strict';
  ...
  return {
    ...
    execute: function () {
      // I am the facade module who provides access to the CommonJS module './request.js'~
      if (!__cjsMetaURL) {
        loader.throwInvalidWrapper('./request.js', module.meta.url);
      }
...
System.register("chunks:///_virtual/api.mjs_cjs=&original=.js", ['./cjs-loader.mjs', './api.js'], function (exports, module) {
  'use strict';
  ...
  return {
    ...
    execute: function () {
      // I am the facade module who provides access to the CommonJS module './api.js'~
      if (!__cjsMetaURL) {
        loader.throwInvalidWrapper('./api.js', module.meta.url);
      }
