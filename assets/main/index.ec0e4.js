  ...
  return {
    ...
    execute: function () {
      ...
      var Base = exports('Base', (_dec = ccclass('Base'), _dec2 = property({
        ...
        _proto.toGameFishCrab = function toGameFishCrab() {
          this.newGame = gameConfig.games["fishcrab"];
          this.toGame();
        };
...
System.register("chunks:///_virtual/main", ['./config.ts', './websocket.ts', './user.ts', './GameController.ts', './modalCommon.ts', './socket.ts', './methods.ts', './Base.ts', './main.ts', './request.mjs_cjs=&original=.js', './api.mjs_cjs=&original=.js'], function () {
  'use strict';
