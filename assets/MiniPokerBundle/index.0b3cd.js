System.register("chunks:///_virtual/Bonus.ts", ['cc', './_rollupPluginModLoBabelHelpers.js', './dataTable.ts'], function (exports) {
  'use strict';

  var cclegacy, _decorator, Node, resources, SpriteAtlas, Component, Sprite, _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _defineProperty, DataTable;
  ...
  return {
    ...
    execute: function () {
       ...
       * Name = Bonus
       * DateTime = Mon Jan 10 2022 17:04:53 GMT+0800 (中国标准时间)
       * Author = rexfd001
       * FileBasename = Bonus.ts
       * FileBasenameNoExtension = Bonus
       * URL = db://assets/GameMiniPoker/scripts/Bonus.ts
...
System.register("chunks:///_virtual/GameMiniPoker.ts", ['cc', './_rollupPluginModLoBabelHelpers.js', './methods.ts', './BaseDialog.ts', './Enums.ts'], function (exports) {
  ...
  var cclegacy, _decorator, Node, Prefab, NodePool, Toggle, instantiate, Vec3, Label, find, Button, Component, _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _defineProperty, fillNumber, getRandomItemFromArray, BaseDialog, MiniPokerType;
    ...
    execute: function () {
      ...
      var GameMiniPoker = exports('GameMiniPoker', (_dec = ccclass('GameMiniPoker'), _dec2 = property({
        ...
        _proto.createNewPoker = function createNewPoker(pokerData, isResult, isSpecialResult, colNum) {
          ...
          poker_item.getComponent("PokerItem").setAnimData(animationName, colNum, this.isFastScroll);
          poker_item.getChildByName("Label").getComponent(Label).string = "" + pokerData.name;
          return poker_item;
        } // 获取一张新扑克节点(优先从对象池获取)
        ;
...
System.register("chunks:///_virtual/MiniPokerBundle", ['./Bonus.ts', './BaseDialog.ts', './DataTableConfig.ts', './Rank.ts', './PokerItem.ts', './PokersScrollContainer.ts', './Enums.ts', './GameMiniPoker.ts', './History.ts', './APIs.ts'], function () {
  'use strict';
